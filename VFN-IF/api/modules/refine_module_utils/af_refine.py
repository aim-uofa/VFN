...
from api.data.residue_constants import (
...
from unicore.modules import LayerNorm, softmax_dropout #TODO: Check if this is the correct import
...
class AFRefineStructureModule(nn.Module):
    def __init__(
        self,
        d_single,
        d_pair,
        ...
        **kwargs,
        ...
        super(AFRefineStructureModule, self).__init__()
    ...
    def forward(
        ...
        # if not self.use_structure_module_output:
