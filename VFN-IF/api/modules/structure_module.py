...
from unicore.modules import LayerNorm, softmax_dropout # TODO: Check if this is correct
...
def torsion_angles_to_frames(
    ...
    all_rots[..., 0, 0] = 1
    all_rots[..., 1, 1] = alpha[..., 1] #1->cos,
    all_rots[..., 1, 2] = -alpha[..., 0]#0->sin,
    all_rots[..., 2, 1:] = alpha
    ...
    all_frames_to_bb = all_frames_to_bb.type(torch.float32)
...
class StructureModule(nn.Module):
    ...
    def forward(
        ...
        outputs["mask"] = mask
        outputs["quat_encoder"] = quat_encoder
