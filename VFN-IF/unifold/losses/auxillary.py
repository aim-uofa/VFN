...
def supervised_chi_loss(
    ...
    **kwargs,
    ...
    # TODO: refactor this.
    # requires_grad = pred_angles_sin_cos.requires_grad
    ...
    loss_dict["chi_loss" if not rm else "chi_loss_rm"] = sq_chi_loss.data
    ...
    loss_dict["angle_norm_loss" if not rm else "angle_norm_loss_rm"] = angle_norm_loss.data
