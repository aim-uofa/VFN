...
mkdir -p ./output_dir/x2/VFN_baseline_64vec_v2/
python train.py ./processed/  \
       ...
       --log-format simple \
       --tensorboard-logdir ./output_dir/x2/VFN_baseline_64vec_v2/tsb \
       --save-dir ./output_dir/x2/VFN_baseline_64vec_v2/ \
       --tmp-save-dir ./output_dir/x2/VFN_baseline_64vec_v2/tmp/ \
       --required-batch-size-multiple 1 \
       --ema-decay 0.999 \
       --model-name VFN_baseline_64vec_v2 \
       --batch-size-valid 1 \
       --json-prefix CATH4.2 \
       --disable-sd \
       --data-buffer-size 32 >> ./output_dir/x2/VFN_baseline_64vec_v2/output.txt 2>&1
